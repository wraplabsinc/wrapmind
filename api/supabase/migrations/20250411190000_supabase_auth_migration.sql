...
-- 3a. organizations
ALTER TABLE organizations DROP POLICY IF EXISTS "Allow all access during development" ON organizations;
...
-- 3b. users
ALTER TABLE users DROP POLICY IF EXISTS "Allow all access during development" ON users;
...
-- 3c. estimates
ALTER TABLE estimates DROP POLICY IF EXISTS "Allow all access during development" ON estimates;
...
-- 3d. clients
ALTER TABLE clients DROP POLICY IF EXISTS "Allow all access during development" ON clients;
...
-- 3e. intake_leads
ALTER TABLE intake_leads DROP POLICY IF EXISTS "Allow all access during development" ON intake_leads;
...
-- 3f. shop_settings
ALTER TABLE shop_settings DROP POLICY IF EXISTS "Allow all access during development" ON shop_settings;
...
ALTER TABLE estimate_notes DROP POLICY IF EXISTS "Allow all access during development" ON estimate_notes;
...
-- 3h. estimate_upsells
ALTER TABLE estimate_upsells DROP POLICY IF EXISTS "Allow all access during development" ON estimate_upsells;
...
-- 3i. audit_log
ALTER TABLE audit_log DROP POLICY IF EXISTS "Allow all access during development" ON audit_log;
...
ALTER TABLE cars DROP POLICY IF EXISTS "Allow all access during development" ON cars;
...
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'wrap_packages') THEN
    ALTER TABLE wrap_packages DROP POLICY IF EXISTS "Allow all access during development" ON wrap_packages;
...
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'wrap_materials') THEN
    ALTER TABLE wrap_materials DROP POLICY IF EXISTS "Allow all access during development" ON wrap_materials;
