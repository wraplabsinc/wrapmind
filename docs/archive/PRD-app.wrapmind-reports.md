...
### New Context
- [x] `ReportsContext.jsx` — fetch all raw data via `useQuery` hooks
- [x] `reportsAggregation.js` — pure functions for each report's calculations

### UI Components
- [x] `ReportsPage.jsx` layout + tab system
- [x] `RevenueTab.jsx` — KPI cards + monthly trend line chart
- [x] `EstimatesTab.jsx` — funnel + table
- [x] `CustomersTab.jsx` — top 10 bar + metrics
- [x] `EmployeesTab.jsx` — ranked table + bar charts
- [x] `MarketingTab.jsx` — funnel + campaign table
- [x] `OperationsTab.jsx` — utilization metrics + technician load

### Wiring
- [x] Add route `/reports` to `App.jsx`
- [x] Add Reports to navigation menu

### Polish
- [x] Date range picker component (presets + custom)
- [x] Location filter dropdown
- [x] CSV export per tab
- [x] Loading spinners + error states
