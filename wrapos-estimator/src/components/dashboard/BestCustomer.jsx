...
const CUSTOMERS = [
  {
    ...
    monthRevenue: 14800,
    lifetimeRevenue: 47200,
    jobsTotal: 4,
    jobsMonth: 1,
    lastVehicle: '2021 Lamborghini Urus',
    lastService: 'Full Color Wrap — Gloss Midnight Black',
    lastDate: 'Apr 7, 2026',
    vehicles: ['2021 Lamborghini Urus', '2022 Porsche Taycan', '2020 Ferrari F8'],
  ...
  },
  {
    ...
    monthRevenue: 11200,
    lifetimeRevenue: 38900,
    jobsTotal: 6,
    jobsMonth: 1,
    lastVehicle: '2022 Range Rover Sport',
    lastService: 'PPF Full Front + Window Tint',
    lastDate: 'Apr 5, 2026',
    vehicles: ['2022 Range Rover Sport', '2023 Bentley Bentayga'],
    tags: ['VIP', 'Repeat'],
    nps: 9,
  },
];
